		...
		public static function initialize() {
			foreach ( apply_filters( 'init_perfops_admin_menus', [] ) as $menu => $submenus ) {
				if ( ! in_array( 'perfopsone-' . $menu, self::$slugs, true ) ) {
					switch ( $menu ) {
						case 'analytics':
							add_menu_page( esc_html__( 'Dashboard', 'ip-locator' ), sprintf( esc_html__( '%s Analytics', 'ip-locator' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_analytics_page' ], 'dashicons-chart-bar', 6666 );
							...
							break;
						case 'tools':
							add_menu_page( esc_html__( 'Available Tools', 'ip-locator' ), sprintf( esc_html__( '%s Tools', 'ip-locator' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_tools_page' ], 'dashicons-admin-tools', 6666 );
							...
							break;
						case 'insights':
							add_menu_page( esc_html__( 'Available Reports', 'ip-locator' ), sprintf( esc_html__( '%s Insights', 'ip-locator' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_insights_page' ], 'dashicons-lightbulb', 6666 );
							...
							break;
						case 'records':
							add_menu_page( esc_html__( 'Available Catalogues', 'ip-locator' ), sprintf( esc_html__( '%s Records', 'ip-locator' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_records_page' ], 'dashicons-book', 6666 );
							...
							break;
						case 'settings':
							add_menu_page( esc_html__( 'Control Center', 'ip-locator' ), sprintf( esc_html__( '%s Settings', 'ip-locator' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_settings_page' ], 'dashicons-admin-settings', 6666 );
							...
							break;
						case 'consoles':
							add_menu_page( esc_html__( 'Available Consoles', 'ip-locator' ), sprintf( esc_html__( '%s Consoles', 'ip-locator' ), 'PerfOps' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_consoles_page' ], 'dashicons-embed-generic', 6666 );
							add_submenu_page( 'perfopsone-' . $menu, esc_html__( 'Available Consoles', 'ip-locator' ), __( 'Available Consoles', 'ip-locator' ), 'manage_options', 'perfopsone-' . $menu, [ self::class, 'get_sconsoles_page' ], 0 );
							break;
					}
