...
<form action="
	...
	<p><?php echo get_submit_button( esc_html__( 'Reset to Defaults', 'ip-locator' ), 'secondary', 'reset-to-defaults', false ); ?>&nbsp;&nbsp;&nbsp;<?php echo get_submit_button( null, 'primary', 'submit', false ); ?></p>
</form>
