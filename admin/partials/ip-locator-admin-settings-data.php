...
<p>
    <?php echo sprintf( esc_html__( '%s main data: ', 'ip-locator' ), 'IPv4' ); ?><strong><?php echo sprintf( esc_html__( '%s / CCO.', 'ip-locator' ), '<a href="https://perfops.one">PerfOps One / Pierre Lannoy</a>' ); ?></strong>
    <br/>
	<?php echo esc_html__( 'Content', 'ip-locator' ) . ': '; ?><strong><?php echo $ipv4; ?></strong>
</p>
<p>
	<?php echo sprintf( esc_html__( '%s main data: ', 'ip-locator' ), 'IPv6' ); ?><strong><?php echo sprintf( esc_html__( '%s / CCO.', 'ip-locator' ), '<a href="https://perfops.one">PerfOps One / Pierre Lannoy</a>' ); ?></strong>
    <br/>
